...
myApp.controller('transcritorController', ['$scope', '$rootScope',
    function($scope,  $rootScope) {
        ...
        //variável publica do escopo
        $scope.frases = [];
        $scope.buttonIcon = "icons/micicon.svg";

        var rodando = false;

        var reconhecimentoDeFala = null;
...
/////////////////////////////////////////////////////////////////////// código do contexto de controle /////////////////////////////////////////////////////////
        ...
        if ('webkitSpeechRecognition' in window) {
            ...
            reconhecimentoDeFala.addEventListener("error", function (erro) {
                console.log(erro);
            }); //caso haja erro ao carregar o speech
...
//Métodos Publicos do controlador...
        ...
        $scope.toggleReconhecimento = function () {
            ...
            if (rodando == false) {
                rodando = true;
                reconhecimentoDeFala.start();
                $scope.buttonIcon = "icons/micicondisabled.svg";
            } else {
                rodando = false;
                $scope.buttonIcon = "icons/micicon.svg";
            }
